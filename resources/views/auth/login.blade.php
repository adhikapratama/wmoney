    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="form-container mt-5 p-4" style="border-radius: 20px">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <a class="d-block mt-2 text-right text-secondary" href="{{ route('forgotPassword') }}">
