...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark px-4">
            <a class="navbar-brand" href="#">
                ...
                <span id="text-brand" class="text-white">WMoney</span>
            </a>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 px-5">
                        <h1 class="text-primary font-weight-bold text-gradient typing-animation text-title">Welcome to WMoney</h1>
                        <p class="text-secondary animation-text">WMoney is your personal money management tool designed to help you keep track of your finances easily and effectively.</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div id="title-about" class="col-lg-6 order-lg-2 order-1 px-5">
                        <h1 class="section-title gradient-secondary mt-5">About WMoney</h1>
                        <p class="section-description text-muted">WMoney was created to address the common challenges people face in managing their personal finances. Our goal is to provide an easy-to-use platform that helps users track their income, expenses, and savings, and make informed financial decisions.</p>
        ...
        <section id="benefits" class="section bg-light">
            <div class="container">
                <h2 class="mt-5 text-center gradient-secondary">Benefits of Using WMoney</h2>
